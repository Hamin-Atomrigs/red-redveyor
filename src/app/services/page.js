          ...
          <div className="px-4 py-5 flex-auto">
            <div className="tab-content tab-space">
              <div className={openTab === 1 ? 'block' : 'hidden'} id="conveyor">
                <h2 className={[`text-xl font-bold mb-8 ${headerFont.className}`]}>컨베이어 설치와 사용에 관한 안내</h2>
              ...
              <div className={openTab === 2 ? 'block' : 'hidden'} id="autocad">
                <h2 className={[`text-xl font-bold mb-8 ${headerFont.className}`]}>기계 도면 제작과 협의 과정 안내</h2>
                <p className={[`text-lg mb-16	${subHeaderFont.className}`]}>
