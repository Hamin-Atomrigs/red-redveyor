            ...
            <div className="tab-content tab-space">
              <div className={openTab === 1 ? 'block' : 'hidden'} id="conveyor">
                ...
                <div className="flex justify-center mt-10 md:mt-16 md:mb-24 2xl:mt-28 2xl:mb-60">
                  <Button height="h-8 2xl:h-12" width="w-32 md:w-32 2xl:w-48" size="text-xs 2xl:text-base" bg="yellow" name="무료 상담하기" link="/quote" />
                </div>
              </div>
              <div className={openTab === 2 ? 'block' : 'hidden'} id="autocad">
                ...
                <div className="flex justify-center mt-10 md:mt-16 md:mb-24 2xl:mt-28 2xl:mb-60">
                  <Button height="h-8 2xl:h-12" width="w-32 md:w-32 2xl:w-48" size="md:text-xs 2xl:text-base" bg="yellow" name="무료 상담하기" link="/quote" />
                </div>
              </div>
            </div>
          </div>
