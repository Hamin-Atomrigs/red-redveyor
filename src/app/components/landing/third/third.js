...
export default function ThirdLanding() {
  return (
    <>
      <div id="portfolio" className="container max-w-xs py-11 mx-auto md:max-w-3xl md:py-7 2xl:max-w-7xl 2xl:py-16" style={{ backgroundImage: 'url(/background-pattern.png)' }}>
