...
export default function Products() {
  ...
  return (
    <>
      <Head>
        <title>컨베이어 설계 및 제작의 중요 고려사항 | 레드컨베이어</title>
        <meta name="description" content="컨베이어 설계 및 제작 시 필수적인 고려사항에 대해 알아보세요. 레드컨베이어는 효율적이고 신뢰할 수 있는 컨베이어 솔루션을 제공합니다." />
        <meta name="keywords" content="컨베이어 설계, 컨베이어 제작, 컨베이어 고려사항, 컨베이어 설계 요소, 효율적인 컨베이어 제작, 신뢰할 수 있는 컨베이어, 컨베이어 제작 전문, 컨베이어 제작 업체, 컨베어, 콘베어, 콘베이어" />
      </Head>
          ...
          <div className="px-4 py-5 max-w-4xl flex-auto">
            <div className="tab-content tab-space">
              ...
              <div className={openTab === 5 ? 'block' : 'hidden'} id="new">
                <h2 className={[`text-xs md:text-base 2xl:text-lg font-bold mb-8 md:mb-9 2xl:mb-16 ${navigationFont.className}`]}>컨베이어 설계 및 제작 시 고려사항</h2>
                <p className={[`text-xs md:text-sm 2xl:text-base mb-5 md:mb-7 2xl:mb-11	${subHeaderFont.className}`]}>
