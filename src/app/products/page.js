        ...
        <div className="px-4 py-5 max-w-4xl flex-auto">
          <div className="tab-content tab-space">
            <div className={openTab === 1 ? 'block' : 'hidden'} id="belt">
              <h2 className={[`text-xl font-bold mb-8 ${headerFont.className}`]}>벨트 컨베이어의 주요 특징</h2>
            ...
            <div className={openTab === 2 ? 'block' : 'hidden'} id="roller">
              <h2 className={[`text-xl font-bold mb-8 ${headerFont.className}`]}>롤러 컨베이어의 주요 특징</h2>
              <p className={[`text-lg mb-16	${subHeaderFont.className}`]}>
            ...
            <div className={openTab === 3 ? 'block' : 'hidden'} id="mash">
              <h2 className={[`text-xl font-bold mb-8 ${headerFont.className}`]}>메쉬 컨베이어의 특징과 용도</h2>
              <p className={[`text-lg mb-16	${subHeaderFont.className}`]}>
                1. <b>다양한 메쉬 소재</b>
                <br />
            ...
            <div className={openTab === 4 ? 'block' : 'hidden'} id="chain">
              <h2 className={[`text-xl font-bold mb-8 ${headerFont.className}`]}>체인 컨베이어의 주요 특징</h2>
              <p className={[`text-lg mb-16	${subHeaderFont.className}`]}>
            ...
            <div className={openTab === 5 ? 'block' : 'hidden'} id="new">
              <h2 className={[`text-xl font-bold mb-8 ${headerFont.className}`]}>효율적인 컨베이어 제작을 위한 고려 사항</h2>
              <p className={[`text-lg mb-16	${subHeaderFont.className}`]}>
